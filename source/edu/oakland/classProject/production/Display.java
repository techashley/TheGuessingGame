...
public class Display {
	...
	* User must select an option.
	...
	/**
 	* Displays calculated results from the user selection.
 	* @param int upperBoundComputed
 	* @param int maxNumOfGuesses
 	*/
	...
	* Welcome title displayed at the beginning of the game.
	*/
	...
	* Will display for user to chose a number.
	...
	*/
	...
	/**
 	* Display for the user to press the return (enter)
